...
async def initialize_components():
    ...
    global auth_manager, config, prometheus_client, storage, unified_analyzer, cluster_collector, cluster_analyzer
...
# Add this new MCP tool after the existing tools:
@app.tool(
